...
with st.form("accident_form"):
    ...
    with col1:
        ...
        vma = st.number_input("Vitesse maximale autorisée (km/h)", min_value=1, max_value=130, value=50)
...
if submit:
    ...
    try:
        ...
        st.error(f"Impossible de contacter l'API. Vérifiez qu'elle est lancée. Erreur : {e}")